...
public class MainActivity extends Activity {
    ...
    public class AndroidBridge {
        ...
        @JavascriptInterface public String getVersion() { return "1.3.0 · PiP Background"; }
    ...
    @Override protected void onUserLeaveHint(){super.onUserLeaveHint();if(videoActive&&Build.VERSION.SDK_INT>=26){try{android.app.PictureInPictureParams p=new android.app.PictureInPictureParams.Builder().setAspectRatio(new android.util.Rational(16,9)).build();enterPictureInPictureMode(p);}catch(Exception ignored){}}}
